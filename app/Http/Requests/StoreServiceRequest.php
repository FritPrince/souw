...
class StoreServiceRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        \Log::info('StoreServiceRequest prepareForValidation - destinations', [
            'has_destinations' => isset($all['destinations']),
        ...
        if ($destinationsInput !== null) {
            if (is_string($destinationsInput) && $destinationsInput !== '') {
                ...
                if (json_last_error() === JSON_ERROR_NONE && is_array($decoded)) {
                    ...
                    \Log::info('StoreServiceRequest - decoded destinations successfully', [
                        'decoded' => $decoded,
                        'count' => count($decoded),
                    ]);
                } else {
                    // Log error for debugging
                    \Log::warning('Failed to decode destinations in StoreServiceRequest', [
                ...
                \Log::info('StoreServiceRequest - destinations already array', [
