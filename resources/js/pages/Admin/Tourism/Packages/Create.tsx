...
export default function Create() {
    ...
    const onSubmit = (e: React.FormEvent) => {
        ...
        post('/admin/tourism/packages', payload, { forceFormData: true });
    };
    ...
    return (
        <AppSidebarLayout breadcrumbs={[{ title: 'Tourisme', href: '/admin/tourism/packages' }, { title: 'Nouveau package', href: '/admin/tourism/packages/create' }]}>
            <div className="p-6">
                <Head title="Nouveau package tourisme" />
                <div className="mb-6 flex items-center justify-between">
                    <h1 className="text-2xl font-bold">Nouveau package tourisme</h1>
