...
export default function Create() {
    ...
    return (
        <AppSidebarLayout breadcrumbs={[{ title: 'Destinations', href: '/admin/destinations' }, { title: 'Nouvelle destination', href: '/admin/destinations/create' }]}>
            <div className="p-6">
                <Head title="Nouvelle destination" />
