...
function layout_sidebar_change(value) {
  if (value == 'dark') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', 'https://html.phoenixcoded.net/light-able/bootstrap/assets/images/logo-white.svg');
    }
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', 'https://html.phoenixcoded.net/light-able/bootstrap/assets/images/logo-dark.svg');
    }
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', 'https://html.phoenixcoded.net/light-able/bootstrap/assets/images/logo-white.svg');
    }
    if (document.querySelector('.landing-logo')) {
      document.querySelector('.landing-logo').setAttribute('src', 'assets/images/logo-white.html');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', 'https://html.phoenixcoded.net/light-able/bootstrap/assets/images/logo-white.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', 'https://html.phoenixcoded.net/light-able/bootstrap/assets/images/logo-white.svg');
    }
    ...
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', 'https://html.phoenixcoded.net/light-able/bootstrap/assets/images/logo-dark.svg');
    }

    if (document.querySelector('.landing-logo')) {
      document.querySelector('.landing-logo').setAttribute('src', 'assets/images/logo-dark.html');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', 'https://html.phoenixcoded.net/light-able/bootstrap/assets/images/logo-dark.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', 'https://html.phoenixcoded.net/light-able/bootstrap/assets/images/logo-dark.svg');
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
      document.querySelector('.theme-layout .btn.active').classList.remove('active');
